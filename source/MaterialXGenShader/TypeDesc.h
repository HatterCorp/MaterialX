...
TYPEDESC_DEFINE_TYPE(IVECTOR3, "ivector3", TypeDesc::BASETYPE_INTEGER, TypeDesc::SEMANTIC_VECTOR, 3)
TYPEDESC_DEFINE_TYPE(IVECTOR4, "ivector4", TypeDesc::BASETYPE_INTEGER, TypeDesc::SEMANTIC_VECTOR, 3)
